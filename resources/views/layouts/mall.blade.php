...
<body>
<div id="login">
    <div class="container">今日:{{Session::get('discuz.post.today_count')}} 昨日:{{Session::get('discuz.post.yesterday_count')}} 帖子:{{Session::get('discuz.post.count')}} 会员:{{Session::get('discuz.user.count')}} 欢迎新会员:{{Session::get('discuz.user.username')}}</div>
</div>
        ...
        <div class="row">
            <nav id="bs-navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="../getting-started/" >车型论坛</a>
                    </li>
                    <li>
                        <a href="../css/" >车主聚会</a>
                    </li>
                    <li class="active">
                        <a href="../components/" >积分商城</a>
                    </li>
                    <li>
                        <a href="../javascript/" >风光官网</a>
                    </li>
                </ul>
