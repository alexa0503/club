                                    ...
                                    @foreach($features as $k=>$feature)
                                        @if($k>0)
                                            <li>
                                                ...
                                                <div class="right">
                                                    <h2><a href="{{$feature->link}}" title="{{$feature->title}}">{{ str_limit($feature->title,30,'…')}}</a></h2>
                                                    <div class="userWrap">
                                                        <div class="name">
                        ...
                        <div id="login">
                            <div class="loginWrap" style="height: 310px;">
                                ...
                                <div class="row remember cl">
                                    ...
                                    <div class="links">
                                        <a href="/bbs/member.php?mod=logging&action=login&_=forgotpasswd&referer=/">忘记密码</a>
                                    </div>
                                </div>
                                <div class="login_b">
