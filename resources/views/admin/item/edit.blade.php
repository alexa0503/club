			...
			<div class="smart-widget-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="colors[]" multiple="multiple" class="select2 form-control" id="colors">
                                @foreach($item->inventories as $inventory)
                                <option value="{{$inventory['color']}}" selected="selected">{{$inventory['color']}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select name="quantities[]" multiple="multiple" class="select2 form-control" id="quantities">
                                @foreach($item->inventories as $inventory)
                                <option value="{{$inventory['quantity']}}" selected="selected">{{$inventory['quantity']}}</option>
                                @endforeach
                            </select>
