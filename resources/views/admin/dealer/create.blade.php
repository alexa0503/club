    ...
    <div class="smart-widget widget-purple">
		<div class="smart-widget-inner">
			<div class="smart-widget-body">
                {{ Form::open(array('route' => ['dealer.store'], 'class'=>'form-horizontal', 'method'=>'POST', 'id'=>'post-form')) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <input value="" name="qq" type="text" class="form-control" id="qq" placeholder="">
                        <label class="help-block" for="" id="help-qq"></label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="tel" class="col-lg-2 col-md-2 control-label">手机</label>
                    <div class="col-lg-10 col-md-10">
                        <input value="" name="tel" type="text" class="form-control" id="tel" placeholder="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <textarea name="intro" type="text" class="form-control" id="intro"></textarea>
