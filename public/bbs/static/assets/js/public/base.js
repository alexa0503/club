...
function isMoJii(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/mojii/i) == 'mojii'){return true;}else{return false;}}

function isECalendar(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/ecalendar/i) == 'ecalendar'){return true;}else{return false;}}

function isSafari(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/safari/i) == 'safari'){return true;}else{return false;}}

function isKugo(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/kgbrowser/i) == 'kgbrowser'){return true;}else{return false;}}
