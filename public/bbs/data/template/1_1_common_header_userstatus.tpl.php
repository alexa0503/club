...
<span class="pipe">|</span><a href="home.php?mod=space&amp;do=pm" id="pm_ntc"<?php if($_G['member']['newpm']) { ?> class="new"<?php } ?>>消息</a>
    ...
    <a href="home.php?mod=spacecp&amp;ac=credit4&amp;showcredit=1" id="extcreditmenu"<?php if(!$_G['setting']['bbclosed']) { ?> onmouseover="delayShow(this, showCreditmenu);" class="showmenu"<?php } ?>>风迷币: <?php echo getuserprofile('extcredits4');; ?></a>
...
<p class="loginTop"><a href="member.php?mod=logging&amp;action=login&amp;referer=forum.php" class="xi2">登录</a><a href="member.php?mod=register" class="xi2">注册</a></p>
